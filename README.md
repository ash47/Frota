...
###More SRCDS Setup Help###
 ...
 - In my experience, if your steam.inf doesn't match up to [THIS DOCUMENT] (http://api.steampowered.com/IGCVersion_570/GetServerVersion/v1?format=xml) then the server may just exit
